...
1. Edit your CMS permissions and see that CiviCRM has added a 'view', 'edit' and 'delete' permission for every financial type. Assign these permissions as needed. You must assign add and view for each financial types to the anonymous user role for visitors to access your contribution pages contributions. 
